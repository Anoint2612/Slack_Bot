...
public class SlackCommandController {
    ...
    private void openJiraModal(String triggerId, String botToken) {
        ...
        String modalPayload = "{ \"type\": \"modal\", \"callback_id\": \"jira_ticket_modal\", \"title\": { \"type\": \"plain_text\", \"text\": \"Create JIRA Ticket\" }, \"submit\": { \"type\": \"plain_text\", \"text\": \"Submit\" }, \"blocks\": [ " +
                ...
                "{ \"type\": \"input\", \"block_id\": \"team_block\", \"label\": { \"type\": \"plain_text\", \"text\": \"Team (optional)\" }, \"optional\": true, \"element\": { \"type\": \"external_select\", \"action_id\": \"team\", \"placeholder\": { \"type\": \"plain_text\", \"text\": \"Start typing to search teams\" }, \"min_query_length\": 3 } }, " + // NEW: Dynamic team select (loads from /slack/options/teams)
                ...
                "{ \"type\": \"input\", \"block_id\": \"labels_block\", \"label\": { \"type\": \"plain_text\", \"text\": \"Labels (optional)\" }, \"optional\": true, \"element\": { \"type\": \"multi_external_select\", \"action_id\": \"labels\", \"placeholder\": { \"type\": \"plain_text\", \"text\": \"Pick your options or create a new label\" }, \"min_query_length\": 3 } }, " +
