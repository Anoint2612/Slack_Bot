...
public class SlackCommandController {
    ...
    private void openJiraModal(String triggerId, String botToken) {
        ...
        String modalPayload = "{ \"type\": \"modal\", \"callback_id\": \"jira_ticket_modal\", \"title\": { \"type\": \"plain_text\", \"text\": \"Create JIRA Ticket\" }, \"submit\": { \"type\": \"plain_text\", \"text\": \"Submit\" }, \"blocks\": [ " +
                ...
                "{ \"type\": \"input\", \"block_id\": \"parent_epic_block\", \"label\": { \"type\": \"plain_text\", \"text\": \"Parent Epic\" }, \"optional\": true, \"element\": { \"type\": \"external_select\", \"action_id\": \"parent_epic\", \"placeholder\": { \"type\": \"plain_text\", \"text\": \"Start typing to search and pick your option\" }, \"min_query_length\": 3 } }, " +
                "{ \"type\": \"input\", \"block_id\": \"components_block\", \"label\": { \"type\": \"plain_text\", \"text\": \"Components\" }, \"optional\": true, \"element\": { \"type\": \"multi_external_select\", \"action_id\": \"components\", \"placeholder\": { \"type\": \"plain_text\", \"text\": \"Pick your options\" }, \"min_query_length\": 0 } }, " +
                ...
                "{ \"type\": \"input\", \"block_id\": \"labels_block\", \"label\": { \"type\": \"plain_text\", \"text\": \"Labels\" }, \"optional\": true, \"element\": { \"type\": \"multi_static_select\", \"action_id\": \"labels\", \"placeholder\": { \"type\": \"plain_text\", \"text\": \"Pick one or more labels\" }, \"options\": [ " +  // Changed to multi_static_select with hardcoded options
